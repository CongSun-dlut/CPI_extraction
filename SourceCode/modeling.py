...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, title_ids, title_type_ids=None, title_mask=None, input_ids=None, token_type_ids=None, attention_mask=None, sdp_ids=None, sdp_type_ids=None, sdp_mask=None, P_gauss1_bs=None, P_gauss2_bs=None, labels=None):
        ...
        output_g = self.activation_final(output_g)
