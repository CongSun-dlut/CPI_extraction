...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, token_type_ids=None, attention_mask=None, P_gauss1_bs=None, P_gauss2_bs=None, labels=None):
        ...
        output = torch.cat((pooled_output, gauss_entity1, gauss_entity2 ), -1)
